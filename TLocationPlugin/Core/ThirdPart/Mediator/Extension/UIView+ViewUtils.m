...
- (void)wm_loadContentsWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)bundleOrNil
{
    ...
    UIView *view = [UIView wm_instanceWithNibName:nibName bundle:bundleOrNil owner:self];
    if (view)
    {
...
- (UIView *)wm_viewMatchingPredicate:(NSPredicate *)predicate
{
    ...
    {
        UIView *match = [view wm_viewMatchingPredicate:predicate];
...
{
    return [self wm_viewMatchingPredicate:[NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, __unused NSDictionary *bindings) {
...
- (NSArray *)wm_viewsMatchingPredicate:(NSPredicate *)predicate
{
    ...
    for (UIView *view in self.subviews)
    {
        ...
        {
        	[matches addObjectsFromArray:[view wm_viewsMatchingPredicate:predicate]];
        }
...
{
    return [self wm_viewsMatchingPredicate:[NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, __unused id bindings) {
...
- (UIView *)wm_firstSuperviewMatchingPredicate:(NSPredicate *)predicate
{
    ...
    return [self.superview wm_firstSuperviewMatchingPredicate:predicate];
}

- (UIView *)wm_firstSuperviewOfClass:(Class)viewClass
{
    return [self wm_firstSuperviewMatchingPredicate:[NSPredicate predicateWithBlock:^BOOL(UIView *superview, __unused id bindings) {
...
- (BOOL)wm_viewOrAnySuperviewMatchesPredicate:(NSPredicate *)predicate
{
    ...
    return [self.superview wm_viewOrAnySuperviewMatchesPredicate:predicate];
}

- (BOOL)wm_viewOrAnySuperviewIsKindOfClass:(Class)viewClass
{
    return [self wm_viewOrAnySuperviewMatchesPredicate:[NSPredicate predicateWithBlock:^BOOL(UIView *superview, __unused id bindings) {
        return [superview isKindOfClass:viewClass];
    }]];
}
...
{
    return [view wm_isSuperviewOfView:self];
}

//responder chain

- (UIViewController *)wm_firstViewController
{
    id responder = self;
...
- (UIView *)wm_firstResponder
{
    return [self wm_viewMatchingPredicate:[NSPredicate predicateWithBlock:^BOOL(id evaluatedObject, __unused id bindings) {
...
{
    [self wm_crossfadeWithDuration:duration];
    if (completion)
    {
