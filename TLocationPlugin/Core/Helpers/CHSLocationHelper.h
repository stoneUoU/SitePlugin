...
@interface CHSLocationHelper : NSObject

@property (class, nonatomic, assign, readonly) CHSLocationHelper *shared;
...
@property (nonatomic, copy, nullable) NSArray<CHSLocationModel *> *cacheDataArray;
