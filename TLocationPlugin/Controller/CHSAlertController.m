...
#import "CHSLocationDefine.h"

@interface CHSAlertController () <UITextFieldDelegate>

@property (nonatomic, assign) BOOL isLoaded;
@property (nonatomic, strong)  UIAlertAction *confirmAction;
@property (nonatomic, copy)  CHSAlertControllerBlock confirmBlock;
@property (nonatomic, strong) NSMutableArray<UIAlertAction *> *mutableActions;

@end

@implementation CHSAlertController

#pragma mark - 构造方法
+ (instancetype)alertWithTitle:(NSString *)title
                       message:(NSString *)message
                  confirmTitle:(NSString *)confirmTitle
                  confirmBlock:(void (^ __nullable)(CHSAlertController *alert, UIAlertAction *action))confirmBlock
                   cancelTitle:(NSString *)cancelTitle
                   cancelBlock:(void (^ __nullable)(CHSAlertController *alert, UIAlertAction *action))cancelBlock
                 isDestructive:(BOOL)isDestructive {
    CHSAlertController *alert = [self alertControllerWithTitle:title
                                                     message:message
...
+ (instancetype)singleActionAlertWithTitle:(NSString *)title
                               ...
                               actionBlock:(void (^ __nullable)(CHSAlertController *alert, UIAlertAction *action))actionBlock {
...
+ (instancetype)destructiveAlertWithTitle:(NSString *)title
                         ...
                         destructiveBlock:(void (^ __nullable)(CHSAlertController *alert, UIAlertAction *action))destructiveBlock {
    return [self alertWithTitle:title
                        message:message
...
+ (instancetype)editAlertWithTitle:(nullable NSString *)title
    ...
    CHSAlertController *alert = [CHSAlertController destructiveAlertWithTitle:title
                                                                  message:message
                                                              cancelTitle:cancelTitle
                                                              cancelBlock:cancelBlock
